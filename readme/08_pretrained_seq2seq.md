...
File gốc: [`vit5_base.yaml`](../configs/vit5_base.yaml)
...
[`DataCollatorForSeq2Seq`](../src/vn_summarization/train.py) tạo batch động:
...
[`train.py`](../src/vn_summarization/train.py) sử dụng `Seq2SeqTrainer`.
