...
Trong [`modeling.py`](../src/vn_summarization/modeling.py):
...
Trong [`causal_data.py`](../src/vn_summarization/causal_data.py):
...
[`CausalDataCollator`](../src/vn_summarization/train_causal_lm.py) pad `input_ids` bằng pad token và pad `labels` bằng `-100`.
...
Config chính: [`qwen3_1_7b_lora.yaml`](../configs/qwen3_1_7b_lora.yaml)
