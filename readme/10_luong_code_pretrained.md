...
Chương này đọc code theo thứ tự thực thi. Repo: [`../pretrained-summarization/`](../pretrained-summarization/)
...
[`utils.py`](../pretrained-summarization/src/vn_summarization/utils.py) chịu trách nhiệm:
...
`load_tokenizer_and_model` trong [`modeling.py`](../pretrained-summarization/src/vn_summarization/modeling.py):
...
Trong [`metrics.py`](../pretrained-summarization/src/vn_summarization/metrics.py):
...
[`evaluate.py`](../pretrained-summarization/src/vn_summarization/evaluate.py):
