...
| File | Trách nhiệm |
|---|---|
| [`data.py`](../pretrained-summarization/src/vn_summarization/data.py) | Load parquet, làm sạch, token hóa source/target |
| [`modeling.py`](../pretrained-summarization/src/vn_summarization/modeling.py) | Load tokenizer/model, dropout, checkpointing, LoRA |
| [`train.py`](../pretrained-summarization/src/vn_summarization/train.py) | Tạo Trainer, train, evaluate, lưu checkpoint |
| [`metrics.py`](../pretrained-summarization/src/vn_summarization/metrics.py) | Decode token và tính ROUGE |
| [`evaluate.py`](../pretrained-summarization/src/vn_summarization/evaluate.py) | Đánh giá checkpoint và xuất prediction JSONL |
| [`predict.py`](../pretrained-summarization/src/vn_summarization/predict.py) | Tóm tắt một văn bản mới |
...
| File | Trách nhiệm |
|---|---|
| [`causal_data.py`](../pretrained-summarization/src/vn_summarization/causal_data.py) | Tạo prompt, nối target, mask label |
| [`train_causal_lm.py`](../pretrained-summarization/src/vn_summarization/train_causal_lm.py) | Load causal LM, LoRA, collator và train |
| [`evaluate_causal_lm.py`](../pretrained-summarization/src/vn_summarization/evaluate_causal_lm.py) | Sinh continuation, làm sạch và tính ROUGE |
