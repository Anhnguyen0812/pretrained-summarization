...
Đọc theo thứ tự: `03 → 04 → 05 → 06 → 07 → 08 → 09 → 10 → 11 → 12`.

### Lộ trình C: Muốn chạy và sửa code pretrained

Đọc theo thứ tự: `05 → 08 → 09 → 10 → 13`.
...
- Báo cáo tiếng Việt: [`../ieee_abstractive_summarization_report_vi.tex`](../ieee_abstractive_summarization_report_vi.tex)
- Mã pretrained: [`../pretrained-summarization/`](../pretrained-summarization/)
